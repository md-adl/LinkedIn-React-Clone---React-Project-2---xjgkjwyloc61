...
function Forgot() {
  ...
  const login = async () => {
    try {
      ...
      alert(errMsg || "Authentication failed. Please log in and try again.");
    }
  };
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      <Box className="signUpBox">
        ...
        />
        <FormLabel sx={{ mt: "20px", mb: "5px" }}>Current Password</FormLabel>
        <OutlinedInput
        ...
        />
        <FormLabel sx={{ mt: "20px", mb: "5px" }}>New Password</FormLabel>
        <OutlinedInput
          id="outlined-adornment-password"
          type={showPassword ? "text" : "password"}
          endAdornment={
